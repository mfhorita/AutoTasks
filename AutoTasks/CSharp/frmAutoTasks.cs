...
namespace AutoTasks
{
    public partial class frmAutoTasks : Form
    {
        ...
        private void frmAutoTasks_Load(object sender, EventArgs e)
        {
            ...
            lblVersao.Text = "Versão " + System.Diagnostics.FileVersionInfo.GetVersionInfo(System.Reflection.Assembly.GetExecutingAssembly().Location).ProductVersion;
        ...
        private void btnRemover_Click(object sender, EventArgs e)
        {
            if (cboItem.SelectedIndex != -1)
            {
                if (MessageBox.Show("Confirma a remoção do programa de número " + cboItem.SelectedItem + " ?", "Questão", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    WriteIniFile("Programa" + String.Format("{0:00}", i), "Parametro", string.Empty, Path.GetFullPath("AutoTasks.cfg"));
        ...
        private void btnAplicar_Click(object sender, EventArgs e)
        {
            ...
            String sDesabilitarTarefa = "1";
            if (chkDesabilitarTarefa.Checked == false)
                sDesabilitarTarefa = "0";
            ...
            WriteIniFile("Programa" + string.Format(cboItem.Text, "00"), "DesabilitarTarefa", sDesabilitarTarefa, Path.GetFullPath("AutoTasks.cfg"));
        ...
        private void LeParametros(int iItem)
        {
            ...
            {
                if (LerIni("DesabilitarTarefa", "Programa" + String.Format("{0:00}", cboItem.SelectedItem)) == 1.ToString())
                {
                    chkDesabilitarTarefa.Checked = true;
                }
                else
                {
